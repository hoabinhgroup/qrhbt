<?php
abstract class Louis_Content_Item_Abstract
{
  ...
  // public $description;
   // public $content;
	...
	//Phương thức này sẽ fetch row item content có liên quan đến table pages
	...
	// Phương thức sẽ trả về 1 mảng gồm những thuộc tính của content
