	...
	class Louis_Pagination
{
    ...
    {   
        ...
        {
            $p = '<nav aria-label="Page navigation" class="pull-right"><ul class="pagination">';
             
            // Nút prev và first
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link('1').'">'.$this->_config['first'].'</a></li>';
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link($this->_config['current_page']-1).'">'.$this->_config['prev'].'</a></li>';
            }
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="page-item active"><span class="page-numbers current">'.$i.'</span></li>';
                }
                else{
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link($this->_config['current_page'] + 1).'">'.$this->_config['next'].'</a></li>';
                $p .= '<li class="page-item"><a class="page-link" href="'.$this->__link($this->_config['total_page']).'">'.$this->_config['last'].'</a></li>';
            }
