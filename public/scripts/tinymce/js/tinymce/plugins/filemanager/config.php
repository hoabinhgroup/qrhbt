...
$base_url="http://tour.louis-intelli.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/public/scripts/tinymce/source/'; // path from base_url to upload base dir
