...
$current = $this->view->current = 'http://hoabinh-group.com'. Zend_Controller_Front::getInstance()->getRequest()->getRequestUri();
    ...
    'limit'         => 4,
    'link_full'     => 'http://timnhanh360.com/tour/ha-noi/{page}',
    'link_first'    => 'http://timnhanh360.com/tour/ha-noi',
    'range'         => 9
);
	...
	//$tour = $this->_product_model->get_details(array('content_type' => 'tour' ,'page' => $params['page'], 'per_page' =>  $per_page ));
		...
		/*	
			$count2 = count($result_arr );
			    $config2 = array(
    'current_page'  => isset($page) ? $page : 1,
    'total_record'  => $count2, // tổng số thành viên
    'limit'         => 4,
    'link_full'     => 'http://timnhanh360.com/tour/ha-noi/{page}',
    'link_first'    => 'http://timnhanh360.com/tour/ha-noi',
    'range'         => 9
